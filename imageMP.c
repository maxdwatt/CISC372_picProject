...
//            destImage: A pointer to a  pre-allocated (including space for the pixel array) structure to receive the convoluted ima>//            algorithm: The kernel matrix to use for the convolution
//Returns: Nothing
